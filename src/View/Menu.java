...
public class Menu extends JFrame {
	...
	public Menu(String usuario) { // passando o usuario que que fez o login
		...
		JMenuItem mntmAtualizaSituaoDe = new JMenuItem("Atualiza Situa\u00E7\u00E3o de Venda");
		mntmAtualizaSituaoDe.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				GerSituacao gersituacao = new GerSituacao();
				gersituacao.setVisible(true);
				gersituacao.setLocationRelativeTo(null);
				gersituacao.atualizarTabela();
			}
		});
		mnApoio.add(mntmAtualizaSituaoDe);
		
		JMenuItem mntmVenda = new JMenuItem("Relatorios");
		mnApoio.add(mntmVenda);
