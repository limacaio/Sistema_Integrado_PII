...
CREATE TABLE IF NOT EXISTS `mydb`.`Produto` (
  ...
  PRIMARY KEY (`idProduto`, `idMarca`, `idCategoria`),
  INDEX `fkMarca` (`idMarca` ASC),
  INDEX `fkCategoria` (`idCategoria` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Vendas` (
  ...
  `idCliente` INT NOT NULL,
  PRIMARY KEY (`idVendas`, `idCliente`, `idSituacao`, `idEndereco`, `idCliente`),
  INDEX `fkCliente` (`idCliente` ASC),
  INDEX `fkSituacao` (`idSituacao` ASC),
  INDEX `fkVendasEndereco` (`idEndereco` ASC, `idCliente` ASC),
  ...
  CONSTRAINT `fk_Vendas_Situacao1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Vendas_Endereco1`
    FOREIGN KEY (`idEndereco` , `idCliente`)
    REFERENCES `mydb`.`Endereco` (`idEndereco` , `idCliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
